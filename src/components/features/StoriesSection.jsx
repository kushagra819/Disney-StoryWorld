...
const STORIES = [
    {
        ...
        accentColor: '#38bdf8',
        pages: [
            { headline: 'THE CORONATION', caption: 'A young queen ascends to the throne of Arendelle, carrying a secret that could destroy everything she loves. The kingdom celebrates, unaware of the storm brewing within their new ruler.', image: '/assets/stories/frozen/download.jpg' },
            { headline: 'POWERS REVEALED', caption: 'In a moment of fear, ice erupts from royal hands. The ballroom freezes. Guests gasp in terror. The queen flees into the night, leaving behind a kingdom plunged into eternal winter.', image: '/assets/stories/frozen/download (1).jpg' },
            { headline: 'THE JOURNEY NORTH', caption: 'A fearless princess sets out with an ice harvester, his reindeer, and a magical snowman to find her sister and bring back summer to a frozen land.', image: '/assets/stories/frozen/download (2).jpg' },
            { headline: 'LET IT GO', caption: 'High in the mountains, the queen builds a palace of ice and finally embraces who she truly is. But below, her kingdom still suffers under an endless winter.', image: '/assets/stories/frozen/hq720.jpg' },
            { headline: 'AN ACT OF TRUE LOVE', caption: 'When all seems lost and ice threatens to consume everything, a selfless act of love proves more powerful than any magic — thawing a frozen heart and an entire kingdom.', image: '/assets/stories/frozen/images.jpg' },
            { headline: 'KINGDOM RESTORED', caption: 'Summer returns to Arendelle. The sisters reunite, and the queen learns that love — not fear — is the key to controlling her extraordinary gift.', image: '/assets/stories/frozen/download.jpg' },
        ],
    },
    {
        id: 'lion-king',
    ...
    },
    {
        ...
        accentColor: '#ec4899',
        pages: [
            { headline: 'THE STOLEN PRINCESS', caption: 'A magic flower heals the queen and imbues her newborn daughter with its golden power. But a vain witch kidnaps the child, hiding her in a tower deep in the forest, raising her as her own.', image: '/assets/stories/rapazunl/hq720.jpg' },
            { headline: '18 YEARS IN THE TOWER', caption: 'The girl grows up behind locked doors, her 70 feet of magical golden hair the only connection to a world she has never known. Every year, she watches floating lights appear on her birthday.', image: '/assets/stories/rapazunl/maxresdefault.jpg' },
            { headline: 'THE THIEF ARRIVES', caption: 'A charming rogue on the run stumbles upon the hidden tower. Armed with a frying pan and fearless determination, the tower girl strikes a deal: he will take her to see the floating lights.', image: '/assets/stories/rapazunl/merlin_171654186_e39b9606-bba7-4b82-8706-0d124ed252b7-superJumbo.jpg' },
            { headline: 'KINGDOM ADVENTURE', caption: 'The outside world is everything she dreamed and more — taverns full of dreamers, palace guards on the chase, and a chameleon companion who trusts no one.', image: '/assets/stories/rapazunl/sufwmiw1yv591.jpg' },
            { headline: 'THE LANTERN CEREMONY', caption: 'On a boat, surrounded by a thousand floating lanterns, the lost princess finally sees the lights up close. In this magical moment, she begins to remember who she truly is.', image: '/assets/stories/rapazunl/hq720.jpg' },
            { headline: 'THE PRINCESS RETURNS', caption: 'The witch\'s deception is shattered. The princess confronts her captor. With a sacrifice of love and the last of her magic, the kingdom\'s lost daughter is finally brought home.', image: '/assets/stories/rapazunl/maxresdefault.jpg' },
        ],
    },
];
