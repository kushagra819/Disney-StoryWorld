...
export const AIStoryGenerator = () => {
    ...
    return (
        <div className="relative z-30 p-8 max-w-2xl mx-auto my-12 bg-slate-900/80 backdrop-blur-md rounded-3xl border border-purple-500/30">
            ...
            {/* Story Reveal Area - Typewriter effect */}
            <AnimatePresence>
                {story && (
                    <motion.div
                        ...
                        className="mt-8 p-6 rounded-2xl bg-black/40 border border-white/5 shadow-[inset_0_0_20px_rgba(168,85,247,0.1)] overflow-hidden relative"
                    >
                        ...
                        <motion.p
                            ...
                            className={`relative z-10 leading-relaxed text-slate-200 ${kidMode ? 'text-2xl' : 'text-lg italic font-serif'}`}
                        >
